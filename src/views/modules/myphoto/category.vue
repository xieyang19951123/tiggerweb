    ...
    <el-tree ref="tree" :data="data" show-checkbox node-key="id" :expand-on-click-node="false" @node-contextmenu="nodeContextmenu" :props="defaultProps" :default-expanded-keys="expandedKeys">
        <div slot-scope="{ node, data }" style="width:100%">
            <span class="custom-tree-node">
                ...
                <svg class="icon" aria-hidden="true" @click="cliclSvg($event)" v-show="node.level >3">
...
@font-face {
    ...
    /* project id 2061655 */
    src: url('//at.alicdn.com/t/font_2061655_hlvbsu9b0y.eot');
    src: url('//at.alicdn.com/t/font_2061655_hlvbsu9b0y.eot?#iefix') format('embedded-opentype'),
        url('//at.alicdn.com/t/font_2061655_hlvbsu9b0y.woff2') format('woff2'),
        url('//at.alicdn.com/t/font_2061655_hlvbsu9b0y.woff') format('woff'),
        url('//at.alicdn.com/t/font_2061655_hlvbsu9b0y.ttf') format('truetype'),
        url('//at.alicdn.com/t/font_2061655_hlvbsu9b0y.svg#iconfont') format('svg');
}
